...
const TransfersByVehicle = () => {
    ...
    const fetchTransfers = async () => {
      ...
      try {
        const response = await httpClient.get(
          `/v1/transfers/vehicle/${vehicleId}`
        );
        if (response.data) {
  ...
  return (
    <div style={{ padding: "20px" }}>
      <Head>
        <title>Transfers List By Vehicle Id</title>
      </Head>
            ...
            <List.Item>
              ...
              >
                ...
                <div style={{ marginTop: "10px" }}>
                  ...
                  <div>
                    <Avatar
                      src={`${app.baseUrl}/${transfer.from_driver.profile_photo}`}
                    />{" "}
                    {transfer.from_driver.name}
                  </div>
                ...
                <div style={{ marginTop: "10px" }}>
                  ...
                  <div>
                    <Avatar
                      src={`${app.baseUrl}/${transfer.to_driver.profile_photo}`}
                    />{" "}
                    {transfer.to_driver.name}
                  </div>
